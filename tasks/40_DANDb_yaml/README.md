...
你可以在 [submissions/40_DANDb_yaml](/submissions/40_DANDb_yaml) 中找到要校对的中文 yaml。你可以在 [tasks/40_DANDb_yaml](/tasks/40_DANDb_yaml) 中找到相对应的英文文档，或者直接在教室中把语言改为英文。
...
2. 打开教室，将语言改为英文，找到你要校对的那一课。或者打开  [tasks/40_DANDb_yaml](/tasks/40_DANDb_yaml) 中的英文 yaml。
3. 开始校对，直接修改 [submissions/40_DANDb_yaml](/submissions/40_DANDb_yaml) 中的文件。
4. 你还可以参考以下资料：
